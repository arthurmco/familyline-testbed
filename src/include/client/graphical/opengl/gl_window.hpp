...
private:
    ...
    std::unique_ptr<gui::GLGUIRenderer> guir_;
...
public:
    ...
    virtual std::unique_ptr<gui::GUIRenderer> createGUIRenderer();
     ...
     */
    virtual void showMessageBox(std::string title, SysMessageBoxFlags flags, std::string content);
