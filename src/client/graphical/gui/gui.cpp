// build command: g++ --std=c++2a -Wall $(sdl2-config --cflags) $(pkg-config pangocairo --cflags)
// gui.cpp control.cpp root_control.cpp gui_label.cpp gui_button.cpp GUIManager.cpp $(sdl2-config
// --libs) $(pkg-config cairo --libs) $(pkg-config pangocairo --libs) -lpthread -g -o gui
...
int main(int argc, char* argv[])
{
    ...
    win = SDL_CreateWindow(
        "GUI Test", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, width, height,
