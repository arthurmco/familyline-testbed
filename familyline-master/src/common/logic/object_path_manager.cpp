 ...
 */
PathHandle ObjectPathManager::startPathing(GameEntity& o, glm::vec2 dest)
{
 ...
 * Get the status of a pathing operation
 */
PathStatus ObjectPathManager::getPathStatus(const GameEntity& o)
{
 ...
 * on land)
 */
std::vector<bool> ObjectPathManager::createBitmapForObject(const GameEntity& o, int ratio)
{
...
void ObjectPathManager::setObjectOnBitmap(
    std::vector<bool>& bitmap, const GameEntity& o, bool value, float ratio)
{
 ...
 */
void ObjectPathManager::setObjectOnBitmap(
    std::vector<unsigned>& bitmap, const GameEntity& o, bool value, float ratio)
{
    auto pos2d = glm::vec2(o.getPosition().x, o.getPosition().z);
    setObjectOnBitmap(bitmap, pos2d, o.getSize(), value, ratio);
}
