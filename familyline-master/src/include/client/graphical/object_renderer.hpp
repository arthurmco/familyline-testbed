...
struct RendererSlot {
    ...
    std::weak_ptr<familyline::logic::GameEntity> component;
    int meshHandle = 0;

    RendererSlot(familyline::logic::object_id_t id, std::weak_ptr<familyline::logic::GameEntity> c)
        : id(id), component(c)
    {
    }
};
...
public:
    ...
    void add(std::shared_ptr<familyline::logic::GameEntity> o);
